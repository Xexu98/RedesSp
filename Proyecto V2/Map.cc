...
std::vector<Vector2D> Map::obstaclesBasePos = std::vector<Vector2D>();
double Map::endY = 200;

Map::Map(SDL_Renderer *renderer, const Vector2D &startPos, int width) : obstacleFilename("./Assets/OilSpill.png"), playerFilename("./Assets/player.png"),
                                                                           backgroundFilename("./Assets/cs2d.jpg"), goalFilename("./Assets/Goal.png"),
...
void Map::setObstaclesPosition(int width, int posY)
{
...
void Map::removeObstacle(GameObject *obstacle)
{
